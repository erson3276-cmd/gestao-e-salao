...
data = json.dumps({
    "phone": "5521982755539",
    "message": "Olá *Eric*! ✨\n\nSeu agendamento de *Pé e Mão Simples* no *Moça ChiQ* foi confirmado! ✅\n\n🗓️ *Data:* 04/04/2026\n🕒 *Horário:* 09:30\n\nTe esperamos para te deixar ainda mais lindo! 🌸",
    "status": "pending"
}).encode('utf-8')
...
try:
    with urllib.request.urlopen(req) as response:
        print("Confirmation message inserted:", response.read().decode('utf-8'))
